        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="relative bg-white shadow-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3">
              <div className="relative overflow-hidden py-10 px-6 bg-orange-700 sm:px-10 xl:p-12">
                <div
                ...
                <p className="mt-6 text-base text-orange-50 max-w-3xl">
                  ...
                  products or services, please don't hesitate to reach out to
                ...
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-orange-50">
                    <FiSmartphone
                      className="flex-shrink-0 w-6 h-6 text-orange-200"
                      aria-hidden="true"
                    />
